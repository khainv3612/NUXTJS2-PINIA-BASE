export default function({ $axios, redirect, store, $auth, $cookies, app }, inject) {
  $axios.onRequest(config => {
    ...
    $axios.setHeader('Access-Control-Allow-Method', ' GET, PUT, POST, DELETE, OPTIONS, post, get')
    $axios.setHeader('Access-Control-Max-Age', '3600')
    $axios.setHeader('Access-Control-Allow-Headers', ' Origin, Content-Type, X-Auth-Token')
